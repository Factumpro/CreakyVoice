function [creak,t_IFP,IFP,PwP,IPS,t_pow,veryShort_powCont_dB,peak_idx,peak_pow,peak_idx_samp] = ...
    ishi_creak_detection_ORIG(x,fs,plots)
...
x_filt1=filtfilt(b1,a1,x); % Zero-phase filtering
Rp = 3; Rs = 40;
Wp = 1500/(fs/2);
Ws = 3000 /(fs/2);
[n,Wn] = buttord(Wp,Ws,Rp,Rs);
[b2,a2]=butter(n,Wn);
x_filt2=filtfilt(b2,a2,x_filt1); % Zero-phase filtering
plot(x_filt-x_filt2)
...
[peak_pow,peak_idx]=findpeaks(veryShort_powCont_dB);
...
[IFP,t_IFP,IFP_peaks] = getIFP(x_filt,fs,IFPthresh,t_pow,peak_idx);
